...
public class AccountServiceImpl implements AccountService {
    ...
    public Stock createStock(Long accountId, Stock stock) {
        ...
        if (portfolioSameTitle != null) throw new GroupExistsException();
    ...
    public Trade createTrade(Long accountId, Stock stock, Portfolio portfolio, Trade trade) {
        ...
        if (s != null) throw new GroupExistsException();
    ...
    public GroupList findStocksByAccount(Long accountId) {
        ...
        return new GroupList(stockRepo.findStocksByAccount(accountId));
    }
